...
@SQLDelete(sql = "UPDATE transfers SET deleted = true WHERE id=?")
...
public class Transfer extends BaseEntity {
    ...
    @DecimalMin(value = "1000", message = "Số tiền chuyển tối thiểu là 1,000 đ")
    @DecimalMax(value = "1000000", message = "Số tiền chuyển tối đa là 1,000,000 đ")
//    @NotBlank(message = "Transfer Amount can not blank")
//    @Pattern(regexp = "^[\\d]*[\\.]?[\\d]*$", message = "Transaction Amount is not valid number")
